...
and, when a review does not complete, the visible failure notice. Both carry the
markers described here, and a consumer cannot tell which component wrote a
given body, nor need to.

Every GitHub-rendered Markdown body a round publishes carries this hidden notice
exactly once:
...
presence to identify Markdown a review round published as AI-generated.
